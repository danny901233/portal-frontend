export interface AgentSetupNavItem {
  ...
  // Hidden for Connect-only (no voice) garages.
  voiceOnly?: boolean;
}
...
export const AGENT_SETUP_NAV: AgentSetupNavItem[] = [
  ...
  { href: '/agent-setup/voice',               label: 'Identity, voice & greeting', description: 'How the agent sounds + first line + pronunciations', voiceOnly: true },
  ...
  { href: '/agent-setup/bookings-transfers',  label: 'Bookings & transfers', description: 'Booking behavior + where to send calls', voiceOnly: true },
