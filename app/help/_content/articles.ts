...
const messagesAndWebchat: Collection = {
  ...
  articles: [
    ...
    },
    {
      ...
      excerpt: 'Upload your customer list once and let staged MOT and service reminders go out on each customer\u2019s own due date.',
      minutes: 5,
      body: [
        { type: 'p', text: 'Outbound is for proactive customer contact \u2014 MOT and service reminders, and one-off messages like an offer or a change of opening hours. Everything lives on the Outbound page, templates included.' },
        { type: 'h', text: 'Before you can send anything' },
        { type: 'p', text: 'WhatsApp only lets a business start a conversation using a template Meta has approved. Two are already drafted for you at the top of the Outbound page \u2014 one for MOT, one for service. Submit them and approval usually lands within a few hours. SMS needs no approval, so you can send straight away.' },
        { type: 'h', text: 'Setting up a campaign' },
        { type: 'ol', items: [
          'Open Outbound and give the campaign a name.',
        ...
        { type: 'h', text: 'How far ahead should I upload?' },
        { type: 'p', text: 'As far ahead as your system will export \u2014 your whole customer book is ideal. Nobody is messaged when the file lands; each customer waits until their own due date is 30 days away. If you upload only the next 30 days, someone due on day 30 gets their first reminder the same day, so upload at least 60 days ahead, or the full list once and top it up.' },
        { type: 'h', text: 'Stopping the follow-ups' },
        { type: 'p', text: 'We cannot see bookings taken over the phone or at the counter, so the reminder ends with a line inviting the customer to say if they have already booked. Any reply \u2014 booking with Leah, or just "already done" \u2014 stops the remaining reminders for that customer. Once a due date passes without a booking, the reminders stop anyway rather than chasing an expired date.' },
        { type: 'h', text: 'How fast messages go out' },
        { type: 'p', text: 'Messages go out about one every 30 seconds, between 8am and 8pm. A few hundred templates leaving one number inside a minute is the shape of a spam run, and WhatsApp scores numbers on how people react to them \u2014 a burst that starts collecting blocks takes the number\u2019s quality rating down with it. Nothing is sent overnight, because a reminder arriving at 2am reads as spam however politely it is worded.' },
        { type: 'p', text: 'There is also a daily cap of 240 messages, set below WhatsApp\u2019s own limit so you never get near it. A number that has barely sent anything before starts lower and builds up. Anything over the day\u2019s allowance is queued and sent automatically the next day \u2014 nothing is dropped, it just goes out over a few days instead of one afternoon. The cap is set by ReceptionMate; if you need it raised, ask us.' },
        { type: 'callout', tone: 'warn', text: 'If WhatsApp flags your messages as spam we stop sending immediately for 24 hours and email you. Please don\u2019t re-send the same list \u2014 carrying on after that warning is what turns a temporary block into a permanently disabled number.' },
        { type: 'h', text: 'Replies' },
        { type: 'p', text: 'Your AI agent answers replies, books the job where it can, and only pulls you in when someone asks for a person. Those conversations appear in Messages, flagged for a human.' },
    ...
    },
    {
      ...
      body: [
        ...
        { type: 'p', text: 'Templates live at the top of the Outbound page \u2014 they are the first step of sending, so they sit above it rather than in their own menu.' },
        { type: 'h', text: 'The two you already have' },
        { type: 'p', text: 'Every messaging account is set up with an MOT reminder and a service reminder already drafted, worded and ready. You do not need to write them \u2014 just press Submit for approval. Meta usually comes back within a few hours.' },
        { type: 'h', text: 'Creating your own' },
        { type: 'ol', items: [
          'Open Outbound and scroll to Templates at the top.',
          'Click New Template.',
          'Type the message body. Use {{1}}, {{2}} etc. for merge fields (e.g. "Hi {{1}}, your MOT for {{2}} is due on {{3}}").',
          'Pick a category — UTILITY for reminders and booking confirmations, MARKETING for offers. Getting this wrong is the most common rejection reason.',
          'Submit. Meta usually approves within a few hours for WhatsApp.',
        ]},
        { type: 'p', text: 'Approved templates show with a green tick and can be picked when you create a campaign. Rejected ones show the reason — usually too marketing-heavy for the category chosen, or missing context about who is messaging.' },
        { type: 'callout', tone: 'tip', text: 'A reminder template should say who you are and why you are messaging, and give the customer a way out — ours end with a line inviting them to say if they have already booked, which also stops the follow-ups.' },
      ],
    },
    {
