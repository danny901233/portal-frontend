  ...
  articles: [
    ...
    },
    {
      ...
      body: [
        ...
        { type: 'p', text: 'Messages are spaced a few seconds apart rather than fired all at once. A few hundred templates leaving one number inside a minute is the shape of a spam run, and WhatsApp scores numbers on how people react to them — a burst that starts collecting blocks can take a number\u2019s quality rating down with it.' },
        { type: 'p', text: 'There is also a daily cap. A number that has barely sent anything before starts lower and builds up, and anything over the day\u2019s allowance is queued and sent automatically the next day — nothing is dropped, it just goes out over a few days instead of one afternoon.' },
        { type: 'h', text: 'Replies' },
