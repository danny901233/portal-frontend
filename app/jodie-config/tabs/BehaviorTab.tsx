    ...
    >
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">
          Use <code className="text-slate-400">{'{name}'}</code> for the agent's name and{' '}
          <code className="text-slate-400">timeofday</code> to be replaced with "good morning"
      ...
      <div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <textarea
                  ...
                  rows={2}
                  className="flex-1 rounded-md border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100 placeholder-slate-500 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                />
                <button
                  type="button"
                  onClick={() => removeRule(idx)}
                  className="shrink-0 rounded-md border border-slate-700 px-2.5 py-1.5 text-xs text-slate-300 hover:bg-slate-800 hover:text-rose-300"
                >
                  Remove
                </button>
              </div>
        ...
        <button
          ...
          className="mt-3 rounded-lg border border-slate-700 px-3 py-1.5 text-sm font-medium text-slate-200 hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
        >
          + Add rule
        </button>
      </div>
