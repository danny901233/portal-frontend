            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <label className="flex shrink-0 cursor-pointer items-center gap-2">
                <input
                  ...
                  className="h-4 w-4 rounded border-slate-300 bg-slate-100 text-emerald-500 focus:ring-emerald-500 disabled:opacity-30"
                />
              ...
              <button
                ...
                className="ml-auto rounded-md border border-slate-300 px-2.5 py-1 text-xs text-slate-600 hover:bg-slate-100 hover:text-rose-300"
              >
                Remove
              </button>
            </div>
