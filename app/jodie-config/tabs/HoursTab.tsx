      ...
      <div className="space-y-2">
        {DAYS.map(({ key, label }) => {
          ...
          return (
            <div
              key={key}
              className="flex flex-wrap items-center gap-3 rounded-lg border border-slate-700/60 bg-slate-950/40 p-3"
            >
              <div className="w-24 shrink-0 text-sm font-medium text-slate-200">
                {label}
              </div>
                ...
                <>
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-sm text-slate-100 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500"
                    />
                  </div>
                  <div className="flex items-center gap-2">
