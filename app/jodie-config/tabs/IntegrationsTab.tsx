...
export default function IntegrationsTab({ config, save, isSaving }: Props) {
  ...
  return (
    ...
    >
      ...
      {provider === 'garage_hive' && (
        <div className="space-y-3 rounded-lg border border-slate-300/60 bg-slate-50 p-4">
          <h3 className="text-sm font-semibold text-slate-700">GarageHive credentials</h3>
