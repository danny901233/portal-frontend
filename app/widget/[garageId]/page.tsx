...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* Menu Options */}
      {viewState === 'menu' && (
        <div className="fixed bottom-24 right-6 z-50 w-[380px] animate-in slide-in-from-bottom-4 duration-200 rounded-2xl shadow-2xl overflow-hidden border border-slate-800" style={{ backgroundColor: '#020617' }}>
          {/* Header */}
          <div className="px-5 py-4 flex items-center justify-between border-b border-slate-800">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-sky-400"></div>
              <h3 className="text-slate-100 font-semibold text-sm">Get in Touch</h3>
            </div>
            <button
              onClick={() => setViewState('closed')}
              className="text-slate-400 hover:text-slate-100 transition-colors p-1.5 hover:bg-slate-800 rounded-lg"
          ...
          {/* Menu Content */}
          <div className="p-4">
            <p className="text-xs text-slate-500 text-center mb-4">Choose your preferred way to reach us</p>
            ...
            <div className="space-y-2">
              ...
              {config.whatsappNumber && (
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all bg-slate-900 hover:bg-slate-800 active:scale-[0.98] border border-slate-800 hover:border-green-500/50"
                >
                  <div className="w-9 h-9 bg-green-500/20 border border-green-500/30 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <div className="text-xs text-slate-500">Message on WhatsApp</div>
                  </div>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all bg-slate-900 hover:bg-slate-800 active:scale-[0.98] border border-slate-800 hover:border-sky-500/50"
              >
                <div className="w-9 h-9 bg-sky-500/20 border border-sky-500/30 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div className="text-left flex-1">
                  <div className="text-sm font-semibold text-slate-100">Live Chat</div>
                  <div className="text-xs text-slate-500">Chat with our AI assistant</div>
                </div>
                <svg className="w-4 h-4 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              ...
              {config.phone && (
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all bg-slate-900 hover:bg-slate-800 active:scale-[0.98] border border-slate-800 hover:border-violet-500/50"
                >
                  ...
                  <div className="text-left flex-1">
                    ...
                    <div className="text-xs text-slate-500">Speak to our AI assistant</div>
                  </div>
                  <svg className="w-4 h-4 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
            ...
            <div className="mt-4 pt-3 border-t border-slate-800 text-center">
              <p className="text-xs text-slate-600">Powered by <span className="font-medium text-slate-500">ReceptionMate</span></p>
            </div>
          </div>
        </div>
      )}
      ...
      >
        {viewState === 'closed' ? (
          <>
            ...
            <span className="text-slate-100 font-semibold text-sm">Chat with us</span>
          ...
          <>
            ...
            <span className="text-slate-400 font-semibold text-sm">Close</span>
          </>
        )}
      </button>
    </>
