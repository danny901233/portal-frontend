  ...
  return (
    <>
          ...
          <div className="absolute top-8 left-0 right-0 flex justify-center">
            {config?.logoUrl ? (
              <div style={{
                ...
                borderRadius: '20px',
                padding: '16px',
                maxWidth: `${(config?.logoSize || 80) * 1.5}px`
              }}>
                <img 
                  src={config.logoUrl} 
                  alt="Logo" 
                  style={{ 
                    maxHeight: `${config?.logoSize || 80}px`,
                    maxWidth: `${(config?.logoSize || 80) * 1.5}px`,
                    objectFit: 'contain',
                    display: 'block'
                  }} 
              ...
              <div style={{
                ...
                <svg style={{ width: `${(config?.logoSize || 80) * 0.6}px`, height: `${(config?.logoSize || 80) * 0.6}px`, color: 'rgba(255, 255, 255, 0.6)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <button
        ...
        style={{ 
          width: viewState === 'closed' ? '64px' : '64px',
          height: '64px',
          background: config?.primaryColor || '#3f51b5',
          ...
          fontWeight: 700,
          fontFamily: "'Poppins', sans-serif",
          borderRadius: config?.buttonShape === 'circle' ? '50%' : config?.buttonShape === 'square' ? '8px' : '16px',
