        ...
        {viewState === 'closed' ? (
          <>
            {isSpinning ? (
              ...
              <>
                <div className={config?.buttonShape === 'pill' ? 'flex items-center gap-2' : ''} style={{
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  width: '100%',
                  ...
                  <div className="rounded-full overflow-hidden" style={{
                    width: config?.buttonShape === 'pill' ? '36px' : '44px',
                    height: config?.buttonShape === 'pill' ? '36px' : '44px',
                    border: `3px solid ${config?.buttonColor || config?.primaryColor || '#3f51b5'}`,
                  ...
                  {config?.buttonShape === 'pill' && <span className="text-white font-semibold">Chat now!</span>}
                </div>
              </>
            )}
          </>
