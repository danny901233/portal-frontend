  ...
  return (
    <>
          ...
          <div className="border-t border-gray-200 p-4 bg-white flex-shrink-0 rounded-b-xl">
            <div className="flex gap-2.5 items-end">
              <input
                ...
                disabled={sending}
                className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all text-sm disabled:bg-gray-100"
              />
              <button
                onClick={handleSendMessage}
                disabled={!input.trim() || sending}
                className="px-5 py-3 rounded-lg flex items-center justify-center text-white font-medium disabled:opacity-50 transition-all hover:shadow-lg active:scale-95 disabled:hover:scale-100 flex-shrink-0 text-sm"
                style={{ backgroundColor: '#2C50EF' }}
              >
                {sending ? (
          ...
          <div className="p-5">
            <p className="text-sm text-gray-600 text-center mb-5">Choose your preferred way to reach us</p>
              ...
              <div className="space-y-2.5">
                ...
                >
                  <div className="w-11 h-11 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#2C50EF' }}>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95"
        style={{ 
          backgroundColor: '#2C50EF',
          boxShadow: '0 4px 14px rgba(44, 80, 239, 0.4)'
        }}
