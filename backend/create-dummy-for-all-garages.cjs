...
async function createDummyForAllGarages() {
  try {
    ...
    console.log(`Found ${garages.length} garages. Creating conversations for each...\n`);

    for (const garage of garages) {
      console.log(`\n=== Creating conversations for: ${garage.name} ===`);
      ...
      console.log(`\n✅ Completed ${garage.name}`);
    }

    console.log('\n\n🎉 All dummy conversations created successfully!');
    console.log('You should now see conversations in all three tabs of the Messages page.');
