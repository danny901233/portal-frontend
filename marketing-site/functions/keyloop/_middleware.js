// Cloudflare Pages Function — gates /keyloop/* behind a single shared password
...
const PASSWORD = "Leah2026";
const COOKIE = "kl_auth";
const TOKEN = "kl-4f1c8e5b2a97d3061e4bc852";
  ...
  if (request.method === "POST") {
    ...
    if (pw === PASSWORD) {
      return new Response(null, {
        status: 302,
        headers: {
          "Set-Cookie": COOKIE + "=" + TOKEN + "; Path=/keyloop; HttpOnly; Secure; SameSite=Lax; Max-Age=2592000",
