// Cloudflare Pages Function — gates /lkqdemo/* behind a single shared password
  ...
  if (request.method === "POST") {
    ...
    if (pw === PASSWORD) {
      return new Response(null, {
        status: 302,
        headers: {
          "Set-Cookie": COOKIE + "=" + TOKEN + "; Path=/lkqdemo; HttpOnly; Secure; SameSite=Lax; Max-Age=2592000",
