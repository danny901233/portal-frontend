---
title: "How much do UK garages lose from missed calls?"
...
1. **Call volume**. A single-site garage with one receptionist sees 40–80 calls a day. A multi-site group can see ten times that.
2. **Average job value**. £180 for a generalist independent, £140 for a tyre specialist, £450 for a body shop, £900+ for performance and prestige.
3. **Conversion rate**. Roughly 35–45% of "booking-intent" calls (where the customer is actively trying to book) convert into a confirmed job.
...
If your garage is sitting on a missed-call problem and wants the number for your own site, [book a 20-minute audit](/get-started) — we'll look at your call records and tell you the real cost before you spend anything on a fix.
