...
# Script to delete user and associated business from production database
# Run this on the EC2 instance

EMAIL="dantyldesley@hotmail.co.uk"

cat > /tmp/delete-user.js << 'EOFSCRIPT'
...
echo "Running deletion script on production database..."
cd /home/ec2-user/receptionmate-backend && node /tmp/delete-user.js
